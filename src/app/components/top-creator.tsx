    ...
    <div className="pt-[3rem] pb-[5rem] bg-blue-950">
      ...
      <div className="w-[80%] pt-[5rem] mx-auto grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-[2rem]">
        ...
        <CreatorCard
          ...
          price={80}
        />
        <CreatorCard image="/images/user3.png" user="Arif Wu" price={59} />
        <CreatorCard image="/images/user2.png" user="Bayu XI" price={30} />
        <CreatorCard image="/images/user1.png" user="Yoga Ma" price={13} />
      </div>
    </div>
  );
};
